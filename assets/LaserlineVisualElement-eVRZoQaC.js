function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/Laserlines.glsl-b1AlaPCs.js","assets/index-BS4ejk0L.js","assets/index-DvE0Cji0.css","assets/Object3DVisualElement-CjWBQfQT.js","assets/VisualElement-CXf3NBDK.js"]
  }
  return indexes.map((i) => __vite__mapDeps.viteFileDeps[i])
}
import{w2 as be,w3 as ve,t_ as d,u9 as P,w4 as j,w5 as L,t$ as r,u0 as te,w6 as B,qA as we,ld as ie,ev as u,fx as ne,fk as Ve,ud as se,_ as ae,uf as re,ug as le,uh as oe,w7 as ce,oq as R,un as he,uv as xe,eN as c,lt as De,eM as q,or as Ee,w8 as Le,w9 as ye,h as Ce,ow as Se,fS as de,E as _,ue as V,wa as Me,fR as Re,m6 as N,wb as Ae,u6 as S,eL as A,fQ as F,e$ as ue,iO as m,f2 as b,wc as pe,f3 as $e,gf as Te,eK as Oe,eV as ge,fT as qe,uc as Ie,mB as ze,wd as We,we as Ne,g1 as G,g0 as W,F as I,J as He,f$ as Ue,wf as je,kJ as k,pd as X,wg as Be,wh as $,wi as Fe,gW as J,op as Ge,ga as ke,wj as Xe,gc as Je,gd as Ke,ge as Qe,wk as Ze,mF as K}from"./index-BS4ejk0L.js";import{t as Ye}from"./VisualElement-CXf3NBDK.js";function fe(e,t){const n=e.fragment;n.include(be),e.include(ve),n.uniforms.add(new d("globalAlpha",i=>i.globalAlpha),new P("glowColor",i=>i.glowColor),new d("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new d("glowFalloff",i=>i.glowFalloff),new P("innerColor",i=>i.innerColor),new d("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new j("depthMap",(i,s)=>{var a;return(a=s.linearDepth)==null?void 0:a.getTexture()}),new L("nearFar",(i,s)=>s.camera.nearFar),new j("frameColor",(i,s)=>s.mainColor)),n.code.add(r`vec4 blendPremultiplied(vec4 source, vec4 dest) {
