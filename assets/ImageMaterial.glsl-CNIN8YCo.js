import{u2 as $,u7 as O,u4 as b,et as l,u1 as u,u5 as S,ua as A,w6 as w,u0 as x,u3 as p,yu as P,u6 as C,ud as c,uf as D,_ as N,w9 as R,oq as y,E as i,ug as o,mr as m,uh as V,ui as M,uj as F,ul as L,um as z,E5 as U,un as j,uo as B,up as G,E6 as W,E7 as q,E8 as H,E9 as k,ur as Q,wo as J,pd as _,Ea as g,Eb as K,Ec as X,wq as Y,Ed as Z,wp as ee,uz as te,Ee as ae,Ef as se,qF as re,uw as ie}from"./index-D2dWKXoe.js";function T(a){const e=new $,{vertex:t,fragment:s}=e;return O(t,a),e.include(b,a),e.attributes.add(l.POSITION,"vec3"),e.attributes.add(l.UV0,"vec2"),a.perspectiveInterpolation&&e.attributes.add(l.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),a.multipassEnabled&&e.varyings.add("depth","float"),t.code.add(u`
    void main(void) {
      vpos = position;
