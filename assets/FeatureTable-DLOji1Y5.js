...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ft={},Zn=/-[a-z]/g,Kn=/([A-Z])/g;function yr(r){return Ft[r]||(Ft[r]=r.indexOf("-")<0?r:r.replace(Zn,t=>t[1].toUpperCase()))}function Ht(r){return Ft[r]||(Ft[r]=r.replace(Kn,"-$1").toLowerCase())}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Os=window.trustedTypes&&trustedTypes.createPolicy("polymer-html-literal",{createHTML:r=>r});class Rr{constructor(t,e){Or(t,e);const i=e.reduce((s,o,n)=>s+Fr(o)+t[n+1],t[0]);this.value=i.toString()}toString(){return this.value}}function Fr(r){if(r instanceof Rr)return r.value;throw new Error(`non-literal value passed to Polymer's htmlLiteral function: ${r}`)}function el(r){if(r instanceof HTMLTemplateElement)return r.innerHTML;if(r instanceof Rr)return Fr(r);throw new Error(`non-template value passed to Polymer's html function: ${r}`)}const Oi=function(t,...e){Or(t,e);const i=document.createElement("template");let s=e.reduce((o,n,a)=>o+el(n)+t[a+1],t[0]);return Os&&(s=Os.createHTML(s)),i.innerHTML=s,i},Or=(r,t)=>{if(!Array.isArray(r)||!Array.isArray(r.raw)||t.length!==r.length-1)throw new TypeError("Invalid call to the html template tag")};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */ye("vaadin-grid",bd,{moduleId:"vaadin-grid-styles"});class vd extends yd(qr(Ii(Wr(pt)))){static get template(){return Oi`
      <div
        id="scroller"
        safari$="[[_safari]]"
        ios$="[[_ios]]"
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */ye("vaadin-checkbox",Od,{moduleId:"vaadin-checkbox-styles"});class zd extends Fd(qr(Ii(pt))){static get is(){return"vaadin-checkbox"}static get template(){return Oi`
 ...
 * Copyright (c) 2016 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class $d extends Nd(Ii(zi(pt))){static get template(){return Oi`
      <div part="content">
        <slot></slot>
      </div>
      <div part="indicators">
